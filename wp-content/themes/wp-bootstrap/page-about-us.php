	...
	<div class="row">
		...
		<div class="span3">
			<a href="<?php echo home_url('about-us/program') ?>">
				<img src="http://lorempixel.com/200/150/people/7" alt="img2" class="img-polaroid">
				<header class="postHeader">
					<h3>Our Program</h3>
				</header>
			</a>
		...
		<div class="span3">
			<a href="<?php echo home_url('about-us/contact-us') ?>">
				<img src="http://lorempixel.com/200/150/people/8" alt="img3" class="img-polaroid">
				<header class="postHeader">
					<h3>Contact Us</h3>
				</header>
			</a>
		...
		<div class="span3">
			<a href="<?php echo home_url('about-us/partners') ?>">
				<img src="http://lorempixel.com/200/150/people/4" alt="img3" class="img-polaroid">
				<header class="postHeader">
					<h3>Partners</h3>
				</header>
			</a>
	...
	<div class="row">
		...
		<div class="span3">
			<a href="<?php echo home_url('about-us/brochure') ?>">
				<img src="http://lorempixel.com/200/150/people/2" alt="img2" class="img-polaroid">
				<header class="postHeader">
